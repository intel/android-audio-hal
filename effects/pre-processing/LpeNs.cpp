...
NsAudioEffect::NsAudioEffect(const effect_interface_s *itfe)
    : AudioEffectStub(itfe, &nsDescriptor)
{

}

const effect_descriptor_t NsAudioEffect::nsDescriptor = {
    .type =         FX_IID_NS_,
    .uuid =         { 0x5312ab60, 0x3c8b, 0x11e3, 0x9808, { 0x00, 0x02, 0xa5, 0xd5, 0xc5, 0x1b } },
