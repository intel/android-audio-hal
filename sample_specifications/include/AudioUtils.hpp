...
public:
    ...
    static const uint32_t _usecToSec = 1000000; /**< Constant used or delays computation */

private:
    static const uint32_t _frameAlignementOn16 = 16; /**< 16 is an audioflinger requirement. */
