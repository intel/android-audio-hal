...
private:
    ...
    static const char *const DEFAULT_GAIN_PROP_NAME; /**< Gain property name. */
    static const float DEFAULT_GAIN_VALUE; /**< Default gain value if empty property. */
    /**
     * Stream Rate associated with narrow band in case of VoIP.
     */
    static const uint32_t VOIP_RATE_FOR_NARROW_BAND_PROCESSING = 8000;
    static const char *const BLUETOOTH_HFP_SUPPORTED_PROP_NAME; /**< BT HFP property name. */
    static const bool BLUETOOTH_HFP_SUPPORTED_DEFAULT_VALUE; /**< Default BT HFP value. */

    static const char *const ROUTE_LIB_PROP_NAME;  /**< Route Manager name property. */
    static const char *const ROUTE_LIB_PROP_DEFAULT_VALUE;  /**< Route Manager lib default value. */

    static const char *const MODEM_LIB_PROP_NAME; /**< MAMGR library name property. */

    static const char *const RESTARTING_KEY; /**< Restart key parameter. */
    static const char *const RESTARTING_REQUESTED; /**< Restart key parameter value. */
};
}         // namespace android
